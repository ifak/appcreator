...
public:
  Logo(const QString& appName,
       const QString& qrcImage,
       QObject* parent=0);

public:
Q_INVOKABLE QString appName();
Q_INVOKABLE QString qrcImage();
...
///Logo
Logo::Logo(const QString& appName,
       const QString& qrcImage,
       QObject* parent)
  : QObject(parent),
    _appName(appName),
    _qrcImage(qrcImage)
{
//  qDebug()<<"welcome logo image path: "<<this->_qrcImage;
}

QString Logo::appName()
{
  return this->_appName;
}

QString Logo::qrcImage()
{
  return this->_qrcImage;
}
    ...
    , m_networkAccessManagerFactory(new NetworkAccessManagerFactory)
{
    ...
    QString currentPath=QDir::currentPath()+QLatin1String("/");
//    qDebug()<<"current welcome path: "<<currentPath;
    QIcon welcomeLogo;
    welcomeLogo.addFile(currentPath
                        +QLatin1String(Core::Constants::IDE_APP_WELCOME_LOGO));
    setIcon(welcomeLogo);
    ...
    m_logo = new Logo(QLatin1String(Core::Constants::IDE_APP_NAME),
                      currentPath+QLatin1String(Core::Constants::IDE_APP_LOGO),
                      this);
...
void WelcomeMode::initPlugins()
{
    ...
    ctx->setContextProperty(QLatin1String("logo"), this->m_logo);
