...
{
//  qDebug()<<"EditorManager::handleContextChange executed! contextList: "<<context;
  ...
  if (editor && editor != d->m_currentEditor) {
    ...
    this->setCurrentEditorFromContextChange();//TODO: seems to work...
...
{
//  qDebug()<<"EditorManager::setCurrentEditorFromContextChange() executed!";
...
{
  QString windowTitle = tr(Constants::IDE_APP_NAME);
