...
{
//  qDebug()<<"Shortcut::setCurrentContext(): ";
//  qDebug()<<"key-sequence: "<<this->m_defaultKey.toString();

//  for(Id id : context)
//    qDebug()<<"context-id: "<<id.toString();

//  qDebug()<<"Shortcut::m_context(): ";
//  for(Id id : m_context)
//    qDebug()<<"m_context-id: "<<id.toString();
