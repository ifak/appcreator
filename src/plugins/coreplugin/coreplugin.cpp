...
CorePlugin::CorePlugin() :
    m_update(new ApplicationUpdate),m_mainWindow(new MainWindow(m_update)), m_editMode(0), m_designMode(0)
{
}
...
bool CorePlugin::initialize(const QStringList &arguments, QString *errorMessage)
{
    ...
    //start updater
    QObject::connect(m_update, SIGNAL(finishCheck(int, bool)),
                     m_update, SLOT(startUpdate(int, bool)));
    QtConcurrent::run(m_update, &ApplicationUpdate::checkRepository, false);
