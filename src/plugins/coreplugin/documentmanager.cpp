...
{
//  qDebug()<<"DocumentManager::syncWithEditor executed! contextList: "<<context;
    if (context.isEmpty())
        return;

    Core::IEditor *editor = Core::EditorManager::currentEditor();
//    qDebug()<<"current editor: "<<editor;
//    qDebug()<<"current editor->widget(): "<<(editor?editor->widget():nullptr);

    if (!editor || editor->isTemporary())
        return;
    foreach (IContext *c, context) {
//      qDebug()<<"context: "<<c;
//      qDebug()<<"context->widget(): "<<c->widget();
...
{
//  qDebug()<<"DocumentManager::setCurrentFile() executed! filePath: "<<filePath;
