    ...
    : QDialog(parent)
{
    ...
    setWindowIcon(QIcon(QLatin1String(Constants::IDE_APP_WINDOW_LOGO)));

    setWindowTitle(tr("About %1").arg(QLatin1String(Constants::IDE_APP_NAME)));
    ...
    logoLabel->setPixmap(QPixmap(QLatin1String(Constants::IDE_APP_VERSION_LOGO)));
