...
#include <update/applicationupdate.hpp>
...
public:
    MainWindow(ApplicationUpdate *updater);
    ~MainWindow();
...
private:
    ...
    bool manualUpdateRunning = false;
};
