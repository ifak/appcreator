...
const char PROJECTEXPLORER_SETTINGS_CATEGORY_ICON[]  = ":/projectexplorer/images/BuildSettings.png";
...
const char TASK_CATEGORY_RUN[] = "Task.Category.Run";
