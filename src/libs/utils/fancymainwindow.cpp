...
{
  qDebug()<<"FancyMainWindow::setLocked(): "<<locked;
  d->m_locked = locked;
  foreach (QDockWidget *dockWidget, dockWidgets()) {
    updateDockWidget(dockWidget);
  }
...
{
//  qDebug()<<"FancyMainWindow::saveSettings()";
...
//  if (!ba.isEmpty())
//  {
//    bool result = restoreState(ba, settingsVersion);
//    qDebug()<<"result of FancyMainWindow::restoreState(): "<<result;
//  }
